...
function Lotto7() {
    ...
    const checkWinLotto = async () => {
        ...
        let winResult = checkLotto7(numbersList, SelectedLuckyMainNumber, SelectedLuckyBonusNumber);
        ...
        for (let i = 0; i < LuckyNumberOrigin.length; i++) {
            if (LuckyNumberOrigin[i].区別 === group) {
                const checkMainNum = [
                    ...
                    ,LuckyNumberOrigin[i].本数字7
                ]
                const checkBonusNum = [
                    LuckyNumberOrigin[i].ボーナス数字1.substring(1,3)
                    ,LuckyNumberOrigin[i].ボーナス数字2.substring(1,3)
                ]
