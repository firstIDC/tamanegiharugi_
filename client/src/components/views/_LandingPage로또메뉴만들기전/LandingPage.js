...
import { Container, Table, Form, FormControl, Button, Row, Col} from 'react-bootstrap';
...
// const test = require("../imgs/loading.gif")
...
function LandingPage() {
    ...
    useEffect(() => {
        setLuckyNumberLine([
                        ...
                        ,"winNumber" : null,"rank" : null,"money" : null}
                        // ,{"index": 6,"luckyNumbers":["","","","","","",""]
                        // ,"winNumber" : null,"rank" : null,"money" : null}
                        // ,{"index": 7,"luckyNumbers":["","","","","","",""]
                        // ,"winNumber" : null,"rank" : null,"money" : null}
                        // ,{"index": 8,"luckyNumbers":["","","","","","",""]
                        // ,"winNumber" : null,"rank" : null,"money" : null}
                        // ,{"index": 9,"luckyNumbers":["","","","","","",""]
                        // ,"winNumber" : null,"rank" : null,"money" : null}
                        // ,{"index": 10,"luckyNumbers":["","","","","","",""]
                        // ,"winNumber" : "null","rank" : null,"money" : null}
                    ]);
        const today = moment();
                ...
                switch (result[0]) {
                    ...
                    case 6:
                        ...
                        if (bonusResult2stAnd3st[0] > 0) {
                            ...
                            luckyNumberFinalResult.push({"index":numbersList[i].index,"rank": "2等","winNumber":result[1],"bonusNums": bonusResult2stAnd3st[1]})
                        } else {
                            //3等(申込数字が本数字6個と一致)
                    ...
                    case 3:
                        ...
                        if (bonusResult6st[0] === 2) {
                            ...
                            luckyNumberFinalResult.push({"index":numbersList[i].index,"rank": "6等","winNumber":result[1],"bonusNums": bonusResult6st[1]})
                        } else {
                            //ハズレ
                            luckyNumberFinalResult.push({"index":numbersList[i].index,"rank": "ハズレ","winNumber":result[1]})
                        }
                        break;
                    default:
                        //ハズレ
